  ...
  const FooterSection = ({ title, links, sectionId }: { title: string, links: { label: string, href: string }[], sectionId: string }) => {
    ...
    return (
      <div className="mb-6 md:mb-0">
        ...
        <ul className={`space-y-2 ${isExpanded || !isMobile ? 'block' : 'hidden'} md:block`}>
          {links.map((link) => (
            <li key={link.label}>
              <Link 
                to={link.href} 
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div className="md:col-span-7 grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
              ...
              <div className="mb-6 md:mb-0">
                ...
                <ul className={`space-y-2 ${expandedSection === "consumer" || !isMobile ? 'block' : 'hidden'} md:block`}>
                ...
                <div className={`mt-4 ${expandedSection === "consumer" || !isMobile ? 'block' : 'hidden'} md:block`}>
            ...
            <div className="md:col-span-4">
              <div className="mb-8">
                ...
                <p className={`text-white text-xs leading-5 ${expandedSection === "mail" || !isMobile ? 'block' : 'hidden'} md:block`}>
              ...
              <div>
                ...
                <p className={`text-white text-xs leading-5 ${expandedSection === "office" || !isMobile ? 'block' : 'hidden'} md:block`}>
                  Flipkart Internet Private Limited,<br />
                  Buildings Alyssa, Begonia &<br />
                  Clove Embassy Tech Village,<br />
                  Outer Ring Road, Devarabeesanahalli Village,<br />
