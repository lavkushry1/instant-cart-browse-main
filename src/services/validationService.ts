...
export interface ZipCodeValidationResult {
  isValid: boolean;
  message?: string;
  // Could also return corrected data or suggestions if applicable
  correctedZip?: string;
 ...
 */
export const validateZipCodeBE = async (zipCode: string, countryCode: string = 'IN'): Promise<ZipCodeValidationResult> => {
